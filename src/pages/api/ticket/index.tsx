...
async function getTicket(req, res) {
  ...
  const file = await screenshot(
    `${getProtocol(req)}://${
      req.headers.host
    }/ticket?uid=${uid}&profileIcon=${profileIcon}&username=${username}&firstname=${firstname}&lastname=${lastname}&status=${status}&account_id=${account_id}`
  )
...
export default allowCors(getTicket)
