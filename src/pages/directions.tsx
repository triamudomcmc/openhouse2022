...
const Directions = () => {
  ...
  const des = {
    bus:             <div className="space-y-10 mt-10">
      <div className="flex space-x-4">
        <h1 className="w-10 h-10 bg-[#9475EB] rounded-full font-black text-2xl flex justify-center items-center">1</h1>
        <div>
      ...
      <div className="flex space-x-4">
        <h1 className="w-10 h-10 bg-[#9475EB] rounded-full font-black text-2xl flex justify-center items-center">2</h1>
        <div>
          <h1 className="text-xl font-semibold">เดินจากสถานี BTS สยาม</h1>
      ...
      <div className="flex space-x-4">
        <h1 className="w-10 h-10 bg-[#9475EB] rounded-full font-black text-2xl flex justify-center items-center">3</h1>
        <div>
    ...
    bts:             <div className="space-y-10 mt-10">
      <div className="flex space-x-4">
        <h1 className="w-10 h-10 bg-[#9475EB] rounded-full font-black text-2xl flex justify-center items-center">1</h1>
        <div>
          <h1 className="text-xl font-semibold">รถประจำทาง</h1>
          <p className="text-lg font-light">ลงป้ายรถประจำทางหน้าโรงเรียน<br/>
            ฝั่งถนนพญาไท<br/>
            สาย 21, 25, 29, 34, 36, 40, 47, 50<br/>
            93, 113, 141, 187, 542</p>
        </div>
      </div>
      <div className="flex space-x-4">
        <h1 className="w-10 h-10 bg-[#9475EB] rounded-full font-black text-2xl flex justify-center items-center">2</h1>
        <div>
          <h1 className="text-xl font-semibold">รถประจำทาง</h1>
          <p className="text-lg font-light">ลงป้ายรถประจำทางหน้าโรงเรียน <br/>
            ฝั่งถนนอังรีดูนังต์<br/>
            สาย 16, 21</p>
        </div>
      </div>
    </div>,
    mrt:             <div className="space-y-10 mt-10">
      <div className="flex space-x-4">
        <h1 className="w-10 h-10 bg-[#9475EB] rounded-full font-black text-2xl flex justify-center items-center">1</h1>
        <div>
  ...
  const [description, setDescription] = useState(des[currentTab])
      ...
      <div className="pt-32 pb-24">
        ...
        <div className="flex lg:flex-row flex-col">
          <div className="relative mx-auto min-w-[320px]">
            {map}
            <div className="absolute top-24 right-0 flex flex-col block lg:hidden space-y-2">
              <div>
                <div onClick={() => {
                  setCurrentTab("bus")
                }}
                     className={classnames("flex justify-center items-center w-[60px] h-[60px] rounded-full shadow-md", currentTab === "bus" ? "bg-[#9475EB]" : "bg-white")}>
                  <svg viewBox="0 0 53 62" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <h1 className="text-center text-xs text-[#575757] mt-1">รถประจำทาง</h1>
              </div>
              <div>
                <div onClick={() => {
                  setCurrentTab("bts")
                }}
                     className={classnames("flex justify-center items-center w-[60px] h-[60px] rounded-full shadow-md", currentTab === "bts" ? "bg-[#9475EB]" : "bg-white")}>
                  <svg viewBox="0 0 52 61" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <h1 className="text-center text-xs text-[#575757] mt-1">BTS</h1>
              </div>
              <div>
                <div onClick={() => {
                  setCurrentTab("mrt")
                }}
                     className={classnames("flex justify-center items-center w-[60px] h-[60px] rounded-full shadow-md", currentTab === "mrt" ? "bg-[#9475EB]" : "bg-white")}>
                  {
                    currentTab !== "mrt" ? <svg className="w-[38px]" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <clipPath id="clip0_1221_4808">
                          <rect width="71.1069" height="61.8083" fill="white" transform="translate(0.515625 0.539062)"/>
                        </clipPath>
                      </defs>
                    </svg> : <svg className="w-[38px]" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h1 className="text-center text-[#575757] text-xs mt-1">MRT</h1>
              </div>
            </div>
          </div>
          <div className="mt-8 mx-auto lg:mt-64 lg:ml-[-200px]">
            <div className="flex space-x-4 lg:flex hidden">
              <div>
                <div onClick={() => {
                  setCurrentTab("bus")
                }}
                     className={classnames("flex justify-center items-center w-[107px] h-[107px] rounded-full shadow-md", currentTab === "bus" ? "bg-[#9475EB]" : "bg-white")}>
                ...
                <h1 className="text-center text-[#575757] mt-1">รถประจำทาง</h1>
              </div>
              <div>
                <div onClick={() => {
                  setCurrentTab("bts")
                }}
                     className={classnames("flex justify-center items-center w-[107px] h-[107px] rounded-full shadow-md", currentTab === "bts" ? "bg-[#9475EB]" : "bg-white")}>
                ...
                <h1 className="text-center text-[#575757] mt-1">BTS</h1>
              </div>
              <div>
                <div onClick={() => {
                  setCurrentTab("mrt")
                }}
                     className={classnames("flex justify-center items-center w-[107px] h-[107px] rounded-full shadow-md", currentTab === "mrt" ? "bg-[#9475EB]" : "bg-white")}>
                  {
                    currentTab !== "mrt" ? <svg width="72" height="63" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_1221_4808)">
                        <path
                          d="M36.0691 0.539062C16.4341 0.539062 0.515625 16.2372 0.515625 35.6091C0.515625 46.322 5.38457 55.9135 13.0572 62.3474H59.0728C66.7471 55.9135 71.6226 46.3234 71.6226 35.6091C71.6226 16.2372 55.7041 0.539062 36.0691 0.539062Z"
                          fill="#C4C4C4"/>
                    ...
                    </svg> : <svg width="72" height="63" viewBox="0 0 72 63" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clipPath="url(#clip0_1221_5087)">
                        <path
                          d="M36.0691 0.539062C16.4341 0.539062 0.515625 16.2372 0.515625 35.6091C0.515625 46.322 5.38457 55.9135 13.0572 62.3474H59.0728C66.7471 55.9135 71.6226 46.3234 71.6226 35.6091C71.6226 16.2372 55.7041 0.539062 36.0691 0.539062Z"
                          fill="white"/>
                ...
                <h1 className="text-center text-[#575757] mt-1">MRT</h1>
              </div>
            </div>
            {des[currentTab]}
          </div>
