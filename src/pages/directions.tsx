...
const Directions = () => {
  ...
  const [map, setMap] = useState(
    <object key={"b"} data="/images/directions/bts.svg" className="w-[100%] h-[404px] lg:w-[700px] lg:h-[884px]" />
  )
    ...
    switch (currentTab) {
      case "bts":
        setMap(
          <object
            key={"b"}
            data="/images/directions/bts.svg"
      ...
      case "bus":
        setMap(
          <object
            key={"a"}
            data="/images/directions/bus.svg"
            className="w-[100%] h-[404px] lg:w-[700px] lg:h-[884px]"
          />
        )
        break
      case "mrt":
        setMap(
          <object
            key={"d"}
            data="/images/directions/mrt.svg"
