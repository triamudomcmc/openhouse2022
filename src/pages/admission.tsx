...
const Milestone: FC<{ data: IMilestoneData; highlight?: boolean }> = ({
  data,
  highlight,
}) => {
  return (
      ...
      <div className="px-4 md:px-12 lg:px-48 flex flex-col space-y-12 w-full items-center">
        <div className="bg-[#e9ceaf] max-w-[600px] rounded-2xl bg-opacity-40 px-8 py-8 flex flex-col items-center">
          <h2 className="font-semibold text-2xl mb-4 text-center">
            เกี่ยวกับโรงเรียนเตรียมอุดมศึกษา
          </h2>
          <p className="indent-4 mb-6 leading-loose font-texts text-justify">
            โรงเรียนเตรียมอุดมศึกษา เป็นโรงเรียนมัธยมปลายขนาดใหญ่พิเศษ
            มีทำเลที่ตั้งอยู่ใจกลางเมือง ติด BTS สถานีสยาม เดินทางสะดวก
            บรรยากาศโดยรอบโรงเรียนมีสีสัน
            รายล้อมไปด้วยห้างสรรพสินค้าและสถานที่สำหรับอ่านหนังสือที่สามารถมาได้ทุกเวลาหลังเลิกเรียน
            เรียกได้ว่าโรงเรียนเตรียมอุดมศึกษาเป็นโรงเรียนที่มีความพร้อมที่จะส่งเสริมศักยภาพของนักเรียนเตรียมฯ
            ในทุกด้าน
          </p>
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="flex flex-col space-y-4 lg:flex-row lg:space-x-4 lg:space-y-0 w-full items-center justify-center">
            <Milestone
              data={{ date: "19-23", month: "ก.พ. 65", event: "เปิดรับสมัคร" }}
            />
            {width > LG ? (
            ...
            <Milestone
              highlight
              data={{ date: "5", month: "มี.ค. 65", event: "วันสอบ" }}
            />
            {width > LG ? (
              <ArrowRightIcon className="w-5 h-5 text-white" />
            ) : (
            ...
            <Milestone
              data={{ date: "12", month: "มี.ค. 65", event: "วันประกาศผล" }}
            />
            {width > LG ? (
              <ArrowRightIcon className="w-5 h-5 text-white" />
            ) : (
            ...
            <Milestone
              data={{ date: "15", month: "มี.ค. 65", event: "รายงานตัว" }}
            />
            {width > LG ? (
              <ArrowRightIcon className="w-5 h-5 text-white" />
            ) : (
            ...
            <Milestone
              data={{ date: "21", month: "มี.ค. 65", event: "วันมอบตัว" }}
            />
          </div>
        </div>
        <div className="flex flex-col justify-center items-center px-4 mt-4 w-full">
          ...
          <p className="text-center sm:text-left text-sm font-light mb-6">
            ท่านรองฯ ทรงเกียรติ เทพประเสนกล่าวถึงข้อมูลเกี่ยวกับการสอบเข้า,
            แนวทางการจัดการเรียนสอน, และอื่น ๆ อีกมากมาย
          </p>
          <div className="flex sm:flex-row flex-col sm:space-y-0 space-y-2 space-x-0 sm:space-x-4 mb-6">
            ...
            <motion.a
              whileHover={{ scale: 1.05 }}
              className="font-light text-center text-md bg-white text-blue-text hover:opacity-90 transition-opacity px-12 py-4 rounded-full"
        ...
        <div className="flex flex-col itesm-center">
          <h2 className="font-semibold text-2xl mt-6 mb-4 text-center">
            การเดินทางมาสถานที่สอบ
          </h2>
          <iframe
          ...
          <article className="flex flex-col w-full max-w-[1260px] xl:space-x-8 xl:flex-row justify-center items-center">
            ...
            <div className="mt-6 flex flex-col space-y-4">
              <div>
                ...
                >
                  <DocumentTextIcon className="inline w-5 h-5" />{" "}
                  อ่านข้อมูลเพิ่มเติมโดยละเอียด
                </motion.a>
              </div>
              <div className="bg-[#C0AFE9] rounded-xl inline bg-opacity-40 px-6 py-8">
                <span className="font-semibold">วิทย์-คณิต สอบ 5 วิขา :</span>{" "}
                คณิตศาสตร์ วิทยาศาสตร์ ภาษาไทย สังคมศึกษา ภาษาอังกฤษ
                <br />
                <span className="font-semibold">
                  ภาษา-คณิต สอบ 4 วิขา :
                </span>{" "}
                คณิตศาสตร์ ภาษาไทย สังคมศึกษา ภาษาอังกฤษ
                <br />
                <span className="font-semibold">
                  ภาษา-ภาษา สอบ 3 วิขา :
                </span>{" "}
                ...
                <ul className="leading-loose flex flex-col space-y-4">
                  <li>
                    <span className="font-semibold text-lg">
                      <LocationMarkerIcon className="inline w-8 h-8" />{" "}
                      สถานที่สอบ - อิมแพ็ค เมืองทองธานี จ.นนทบุรี
                    </span>
                  </li>
                  <li>
                    <span className="font-semibold text-lg">
                      <PencilAltIcon className="inline w-8 h-8" />{" "}
