...
export default function AdminIndex() {
  ...
  if (user?.roles?.hasOwnProperty("tucmc"))
    return (
        ...
        <div className="mt-[150px] lg:mt-[249px] max-w-[1151px] w-full mx-[100px]">
          <div className="relative">
            ...
            <div className="lg:mt-[103px] mt-[50px] flex justify-between">
              ...
              <div className="flex">
                <p className="text-[26px] leading-[45px] mx-[20px]">
                  {focusType == "club"
                    ? "ชมรม"
                    : focusType == "organization"
                    ? "องค์กรนักเรียน"
                    : focusType == "programmes"
                    ? "สายการเรียน"
                    : "all"}
                </p>
                <HamburgerButton
            ...
            >
              <div className={`flex flex-col w-full text-black bg-white bg-opacity-90 font-display text-center`}>
                <div className="text-[20px] font-[500] px-[20px] py-[5px]">
                  <button className="hover:underline" onClick={() => setFocusType("")}>
                    all
                  </button>
                </div>
                <div className="text-[20px] font-[500] px-[20px] py-[5px]">
                  <button className="hover:underline" onClick={() => setFocusType("club")}>
                    ชมรม
                  </button>
                </div>
                <div className="text-[20px] font-[500] px-[20px] py-[5px]">
                  <button className="hover:underline" onClick={() => setFocusType("programmes")}>
                    สายการเรียน
                  </button>
                </div>
                <div className="text-[20px] font-[500] px-[20px] py-[5px]">
                  <button className="hover:underline" onClick={() => setFocusType("organization")}>
                    องค์กรนักเรียน
                  </button>
                </div>
              </div>
                        ...
                        <div className="flex items-center lg:h-[106px] bg-[#3A3A3A] rounded-[20px] mb-[100px]">
                          <div className="flex justify-between w-full">
                            <div className="ml-[45px]">
                              <h5 className="lg:text-[25px] lg:leading-[50px] text-white">{val.nameTH}</h5>
                            </div>
                            <div className="mr-[50px]">
                              <motion.button
                                ...
                                className="w-[52px] h-[52px] bg-[#19C57C] rounded-xl mx-3"
                              >
                                <CheckIcon className="w-[30px] mx-auto text-white" />
                              </motion.button>
                              <motion.button
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                                onClick={() => decline(val.id, key)}
                                className="w-[52px] h-[52px] bg-[#E80808] rounded-xl mx-3"
                              >
                                <XIcon className="w-[30px] mx-auto text-white" />
                              </motion.button>
                            </div>
                          </div>
                        </div>
