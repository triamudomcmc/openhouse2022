...
const Editor = ({ clubId }) => {
  ...
  if ((user?.club == clubId || user?.roles?.hasOwnProperty("tucmc")) && status)
    return (
        ...
        <div className="mx-auto pt-[104px] w-[311px] lg:w-[1000px] lg:pt-[178px]">
          <Link href={`/clubs/${[clubId]}`}>
            <button className="flex max-lg:ml-0 max-[1080px]:ml-[30px]">
              ...
              <p className="text-xs leading-[15px] ml-[3.68px] lg:ml-[7.25px] lg:text-xl lg:leading-[29px] ">
                ย้อนกลับ
              </p>
            </button>
          </Link>
          <div className="lg:flex justify-between w-[225px] lg:w-[978px] mx-auto mt-[18px] lg:mt-[41px]">
            <div className="w-[220px] lg:w-[335px] lg:ml-[29px]">
              <p className="text-left text-[16px] leading-[21px] lg:text-[24px] lg:leading-[30px] mt-[25.7px] lg:mt-[9px] text-[#5C5C5C] flex flex-row">
                สถานะ :
                <span
                  className={`ml-[5px] ${
                    status == "Approved" ? "text-[#19C57C]" : status == "Pending" ? "text-[#FCB52B]" : "text-[#E80808]"
                ...
                >
                  ...
                  >
                    <circle
                      ...
                      cy="10"
                      r="10"
                      fill={`${status == "Approved" ? "#19C57C" : status == "Pending" ? "#FCB52B" : "#E80808"}`}
                    />
                  </svg>
                  <svg
                    className="lg:hidden"
            ...
            <div className="mt-[16px] flex justify-between">
              <Link href={`/clubs/${[clubId]}/preview`}>
                <button className="w-[106.8px] h-[28.8px] lg:w-[192px] lg:h-[52px] border-blue-edit-300 box-border border-[1.2px] lg:border-[2px] rounded-[112px] lg:rounded-[200px]">
                  <p className="text-center text-[14px] leading-[17px] lg:text-xl font-500 text-blue-edit-300">
                    Preview
                  </p>
                </button>
              </Link>
              <button
                className="w-[108px] h-[30px] lg:w-[192px] lg:h-[52px] border-blue-edit-300 box-border border-2 rounded-[112px] lg:rounded-[200px] text-[24px] font-[400] bg-blue-edit-300  ml-[19px] "
                onClick={publishToPending}
              >
                <p className="text-center text-[14px] leading-[16.94px] lg:leading-[48px] lg:text-xl text-white">
                  ส่งการแก้ไข
                </p>
              </button>
            </div>
        ...
        <div className="mx-auto mt-[18px] w-[330px] lg:w-[771px] lg:mt-[27px]">
          <div className="w-[328px] h-[330px] rounded-[27px] flex flex-col lg:flex-row lg:w-[771px] lg:h-[240px] lg:rounded-[31.18px] shadow-[2px_2px_4px_rgba(0,0,0,0.3)] mt-[27px]">
            ...
            <div className="text-center lg:w-[485px]">
              <div className="lg:h-[92px] mt-[20px] lg:mt-[29px]">
                ...
                <h2 className="h-[24px] lg:h-[29px] font-[400px] text-md lg:text-xl text-gray-500 mt-[1px]">
                  {info.nameEN}
                </h2>
                <h2 className="h-[21px] text-[17px] leading-[21px] lg:h-[24px] lg:text-[20px] leading-md lg:mt-[5px] text-gray-500 mt-[3px]">
          ...
          <div>
            ...
            <div className="w-full mx-auto">
              ...
              <input
                type="text"
                className="w-full text-xs text-center border-hidden mt-[4px] lg:text-sm lg:mt-[14px]"
                placeholder="คำอธิบายรูปภาพ"
                value={clubArticleDes}
                onChange={(txt) => {
                  setClubArticleDes(txt.target.value)
                }}
              />
            </div>
          ...
          <div>
            ...
            <div className="w-full mx-auto">
              ...
              <input
                ...
                value={advantageDes}
                onChange={(txt) => {
                  setAdvantageDes(txt.target.value)
                }}
              />
            </div>
