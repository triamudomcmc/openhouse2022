  ...
  return (
    ...
    >
      <main className="mx-auto w-[90vw] max-w-[975px]">
        <iframe
          className="bg-black w-[90vw] h-[48vw] max-w-[975px] max-h-[548px] border border-white border-opacity-50 rounded-xl"
        ...
        <div className="flex lg:flex-row flex-col mt-6 lg:space-x-10">
          ...
          <div className="flex lg:flex-col md:flex-row flex-col lg:w-5/12 space-y-8 md:space-y-0 lg:space-y-8 mt-8 lg:mt-0">
            {/* <div className="rounded-xl border px-8 py-6 space-y-3 w-full md:w-1/2 lg:w-full mb-4">
