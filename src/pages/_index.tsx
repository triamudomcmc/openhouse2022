    ...
    <Link href={"/"}>
      <div style={{background: "linear-gradient(241.39deg, rgba(255, 255, 255, 0.4) 18.81%, rgba(255, 255, 255, 0) 100.07%)"}}
        ...
        <div>
          ...
          <div className="px-2">
            <h1 className="break-all text-[12px] h-[56px] font-light text-ellipsis">ชื่อวิดีโอยาววววววววววววววววววววววววววววววววววว</h1>
...
export default function Home() {
  ...
  return (
    <div className="font-display">
      <div>
        <AdaptiveBg primary={{background: "url('images/backgrounds/landing.jpg')", height: "1024px"}}
        ...
        <AdaptiveBg primary={{background: "url('images/backgrounds/branches.jpg')", height: "1771px"}}
          ...
          <div className="pl-0 sm:pl-[200px] mx-auto w-max sm:h-[760px]">
            <div className="mt-[130px] sm:mt-[300px] relative w-max">
              ...
              <div
                className="w-[300px] sm:w-[394px] h-[78px] sm:h-[96px] absolute border-[5px] border-yellow-500 rounded-[50%] rotate-[-6deg] top-[50px] sm:top-[74px] left-[-34px] z-[2]"/>
              <h1 className="font-light text-lg sm:text-xl tracking-wider mt-10 w-max">คลิกที่ดวงดาวเพื่ออ่านข้อมูลสายการเรียน</h1>
            </div>
          </div>
        ...
        <AdaptiveBg primary={{background: "url('images/backgrounds/gifted.jpg')", height: "1124px"}}
            ...
            <div className="space-y-16 lg:mt-0 mt-20">
              <div className="flex flex-row md:space-x-16 space-x-4 items-center md: items-start">
                <div onClick={() => {
                  ...
                  <h1 className="absolute bottom-[20px] left-[26px] text-[20px] sm:text-[24.67px] font-semibold text-black">GIFTED-<br/>SCIENCE</h1>
                </div>
                <div onClick={() => {
                  ...
                  <h1 className="absolute bottom-[20px] left-[26px] text-[20px] sm:text-[24.67px] font-semibold text-black">GIFTED-<br/>MATH</h1>
                </div>
              </div>
              <div className="flex flex-row md:space-x-16 space-x-4 items-center md: items-start">
                <div onClick={() => {
                  ...
                  <h1 className="absolute bottom-[20px] left-[26px] text-[20px] sm:text-[24.67px] font-semibold text-black">GIFTED-<br/>ENGLISH</h1>
                </div>
                <div onClick={() => {
                  ...
                  <h1 className="absolute bottom-[20px] left-[26px] text-[20px] sm:text-[24.67px] font-semibold text-black">GIFTED-<br/>THAI</h1>
                </div>
              </div>
            </div>
          </div>
