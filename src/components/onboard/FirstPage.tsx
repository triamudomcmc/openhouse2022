...
export const FirstPage: FC<{
  ...
  return (
    <AnimateSharedLayout>
      ...
      >
        {({errors, values}) => (
          <Form className="py-4 px-4 text-sm w-[20rem] h-[924px] sm:w-[24rem] text-gray-700 font-display" noValidate>
            ...
            {["student", "teacher"].includes(values.status) && (
              <>
                {/* <hr className="text-white my-2 h-4" /> */}
                <motion.div initial={{y: -20, opacity:0}} animate={{y: 0, opacity: 1}} transition={{delay: animated ? 0 :1.2}} layout="position">
                ...
                {values.status === "student" && (
                  <motion.div initial={{y: -20, opacity:0}} animate={{y: 0, opacity: 1}} transition={{delay: animated ? 0 : 1.4}} layout="position">
            ...
            {/* submit */}
            <motion.div initial={{y: -20, opacity:0}} animate={{y: 0, opacity: 1}} transition={{delay: animated ? 0 : 1.6}} onAnimationComplete={() => {setAnimated(true)}} layout={"position"} className="pt-8 pb-6 text-white">
