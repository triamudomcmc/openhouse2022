export const Nav = () => {
  return (
    <header className="flex absolute z-50 top-0 left-0 py-2 px-8 mb-16 w-full text-white border-b border-white border-opacity-20 rounded-lg backdrop-blur-lg font-display navbar-bg">
