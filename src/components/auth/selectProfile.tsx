...
const Pillar = () => {
  return (
    <svg width="226" height="984" viewBox="0 0 226 984" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M50.4917 0V0.58328C22.4678 1.47355 0 24.6514 0 53.2323C0 81.8132 23.3482 105.943 52.1312 105.943C59.9949 105.943 67.4336 104.131 74.1132 100.969V982.588L225.133 982.802V0.245599L50.4613 0.0307057L50.4917 0Z" fill="url(#paint0_linear_915_2568)"/>
      ...
      <path d="M74.9326 192.422V983.201H97.6129V238.563C97.6129 233.467 101.681 229.353 106.721 229.353C111.762 229.353 115.83 233.467 115.83 238.563V983.201H141.182V238.563C141.182 233.467 145.251 229.353 150.291 229.353C155.331 229.353 159.399 233.467 159.399 238.563V983.201H183.507V238.563C183.507 233.467 187.575 229.353 192.615 229.353C197.655 229.353 201.724 233.467 201.724 238.563V983.201H225.649V192.422H74.9326V192.422Z" fill="url(#paint1_linear_915_2568)"/>
      ...
      <defs>
        <linearGradient id="paint0_linear_915_2568" x1="112.551" y1="264.903" x2="112.551" y2="8.38086" gradientUnits="userSpaceOnUse">
        ...
        <linearGradient id="paint1_linear_915_2568" x1="150.807" y1="315.741" x2="149.751" y2="852.976" gradientUnits="userSpaceOnUse">
          <stop stopColor="#E3AA86"/>
...
const ExtendablePillarBottom = () => {
  return <svg width="151" height="3168" viewBox="0 0 151 3168" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path fillRule="evenodd" clipRule="evenodd" d="M0 0V3080.51H149.866V0H0Z" fill="url(#paint0_linear_920_2568)"/>
    <path fillRule="evenodd" clipRule="evenodd" d="M0 0V3168H22.6803V0H0ZM40.8974 0V3168H66.2495V0H40.8974ZM84.4666 0V3168H108.574V0H84.4666ZM126.791 0V3168H150.716V0H126.791Z" fill="url(#paint1_linear_920_2568)"/>
    <defs>
      <linearGradient id="paint0_linear_920_2568" x1="74.9331" y1="2103.41" x2="74.9331" y2="-321.982" gradientUnits="userSpaceOnUse">
        <stop stopColor="#CC7754"/>
        <stop offset="0.44" stopColor="#CE886F"/>
      </linearGradient>
      <linearGradient id="paint1_linear_920_2568" x1="75.8743" y1="-504.442" x2="43.9287" y2="2451.15" gradientUnits="userSpaceOnUse">
        <stop stopColor="#E3AA86"/>
        <stop offset="0.02" stopColor="#E4AD89"/>
        <stop offset="0.11" stopColor="#E9BC9A"/>
        <stop offset="0.22" stopColor="#ECC5A4"/>
...
export const SelectProfile: FC<{
  ...
  const ProfileSelection = ({id}) => {
    return (
      <div onClick={() => {setProfile(id)}} className={classnames("flex items-center cursor-pointer justify-center pb-2 rounded-2xl w-[124px] h-[124px] shadow-md mr-4 mt-2", profile === id ? "bg-gray-300" : "bg-white")}>
  ...
  return (<div style={{background: "linear-gradient(360deg, #F4CBA5 -0.18%, #FFF6E8 102.34%)"}} className="py-24 min-h-screen">
    ...
    <div className="flex flex-col items-center relative z-[1] px-6">
      ...
      <div className="mt-14">
        ...
        <div>
          <div style={{background: "linear-gradient(90.95deg, #FFA16F 12.94%, #4461AD 114.9%)"}} className="rounded-full text-white px-4 mt-5 font-semibold text-[18px] py-0.5 w-full">
            <span>น้องแมว</span>
          </div>
        ...
        <p className="text-center mt-5 text-deep-turquoise">
          การลงทะเบียนถือว่ายอมรับ<span className="text-bright-orange hover:underline cursor-pointer">นโยบายความเป็นส่วนตัว</span><br/>
